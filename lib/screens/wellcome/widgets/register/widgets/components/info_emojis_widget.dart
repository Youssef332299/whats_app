...
import '../../../../../../../data/services/emoji_services.dart';

class InfoEmojisWidget extends StatefulWidget {
  final Function addEmojiToTextController;

  const InfoEmojisWidget({
    super.key,
    required this.addEmojiToTextController,
  });

  @override
  State<InfoEmojisWidget> createState() => _EmojisWidget();
}

class _EmojisWidget extends State<InfoEmojisWidget>
        ...
        child: Column(
          children: [
            TabBar(
              ...
              labelColor: isDarkMode ? Colors.white : messageColor,
